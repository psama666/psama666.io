window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "heatmaps": [{
        "id": 8051271,
        "created_epoch_time": 1625088929,
        "targeting": [{
            "component": "url",
            "match_operation": "exact",
            "pattern": "https://estudionk.com/awards",
            "negate": false
        }],
        "selector_version": 2,
    ...
    322: function(e, t) {
        window.hjBootstrap = window.hjBootstrap || function(e, t, n) {
            ...
            if (a.test(r)) console.warn("Hotjar not launching due to suspicious userAgent:", r);
                ...
                }, s.varsJar = p, "interactive" === u.readyState || "complete" === u.readyState || "loaded" === u.readyState ? h() : u.addEventListener("DOMContentLoaded", h), s.revision = "286450c52848", window.hjBootstrap = s)
            }
        ...
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.189ddfe225c89657c20d.js", "1516725"), window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
                js: "survey-v2.52312defb949a6bc5a30.js"
            },
            SURVEY_BOOTSTRAPPER: {
                js: "survey-bootstrapper.0d626c5b1a155b975e73.js"
            },
            SURVEY_ISOLATED: {
                js: "survey-isolated.1c59ef4bc5205024ba06.js"
            },
            HEATMAP_SCREENSHOTTER: {
                js: "heatmap-screenshotter.75c059dec3673e6fe85f.js"
            },
            HEATMAP_VIEWER: {
                js: "heatmap-viewer.600806f4d8d72659297f.js"
            },
            SURVEY_INVITATION: {
                js: "survey-invitation.f5c39a28378ea1f59ac0.js"
            },
            NOTIFICATION: {
                js: "notification.b540417900e18715683d.js"
            },
            INCOMING_FEEDBACK: {
                js: "incoming-feedback.728d95044100f23cdfdd.js"
            },
            PREACT_INCOMING_FEEDBACK: {
                js: "preact-incoming-feedback.20eec70ef409153e0c7f.js"
            },
            SENTRY: {
                js: "sentry.7d668686feb347060016.js"
            }
        }
    }
});